...
public class HTMLReport {
	...
	public HTMLReport(String reportDir, String reportTitle, String build) {
		...
		"<html>"
				...
				+ "</head>"
				+ "<body>"
				+ "<div style=\"font-weight: bold;background-color: #CACABD;padding:12px\"><td>Date :"
				...
				+ "</td></div>"
				+ "<br/>"
				+ "<div style=\"font-weight: bold;text-align:center;background-color: #0099FF;font-size: 25px;padding:15px\" >"
				+
				...
				"<center><font SIZE=\"+4\"><img SRC=\"http://blog.harri.com/wp-content/uploads/2015/01/Harri_logo_tall.png\" X-SAS-UseImageWidth X-SAS-UseImageHeight ALIGN=\"bottom\" WIDTH=\"400\" HEIGHT=\"100\"></font></center></p><h3><center>"
				+
				...
				+ "<tr style=\"background-color:#CACABD;font-weight: bold\">"
	...
	public void generateReport() throws IOException {
		...
		"</table>"
				+ "<br/>"
				+ "<br/>"
				+ "<br/><br/><table border=1px width=100%><tr style=\"background-color:#0099FF;font-weight: bold;font-size: 18px\"><td>Number Of Tests : "
